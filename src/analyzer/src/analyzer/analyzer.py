...
from interface import Message, AnalysisResult, Analyzer
...
class EmailAnalyzer(Analyzer):
    ...
    def get_insights(self, analysis_results: list[AnalysisResult]) -> dict[str, Any]:
        ...
        topic_frequencies = {topic: all_topics.count(topic) for topic in set(all_topics)}
